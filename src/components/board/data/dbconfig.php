...
define('G5_MYSQL_USER', 'cobluestar');
define('G5_MYSQL_PASSWORD', 'al05sn0!');
define('G5_MYSQL_DB', 'cobluestar');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'b0b4b186736a59ac080e534657ad1007'); // 토큰 암호화에 사용할 키
